...
,"2Sa":"10","2Sm":"10","撒下":"10"
,"11":{"cn":"列王紀上","cb":"王上","en":"1Kings","eb":"1Ki"}
,"1Ki":"11","王上":"11"
,"12":{"cn":"列王紀下","cb":"王下","en":"2Kings","eb":"2Ki"}
,"2Ki":"12","王下":"12"
,"13":{"cn":"歷代志上","cb":"代上","en":"1 Chronicles","eb":"1Ch"}
,"1Ch":"13","1Chr":"13","代上":"13"
,"14":{"cn":"歷代志下","cb":"代下","en":"2 Chronicles","eb":"2Ch"}
,"2Ch":"14","2Chr":"14","代下":"14"
...
,"1Pe":"60","1Pet":"60","彼前":"60"
,"61":{"cn":"彼得後書","cb":"彼後","en":"2 Peter","eb":"2Pe"}
,"2Pe":"61","2Pet":"61","彼後":"61"
...
var book_index=0, chapter_index, verse_index
...
for (f=0;f<files.length;f++) {
	...
	out=['<xml id="'+file+'" info="'+text[0]+'">','<pb n="1"/>']
	for (i=1;i<text.length;i++) {
	//	if (i>20) break
		line=text[i]
		if (!line) continue
		match=line.match(/(\d?\D+?) ?(\d+):(\d+)\s+(.+)/)
		if (!match) continue
		if (book_id!==match[1]) {
			book_id = match[1], book_index++, N=naming[book_id]
